...
const Page = () => {
    return <section id="Contact">
        ...
        <form className="flex flex-col justify-center items-center gap-4 w-[90%] md:w-[50%]">
            <div className="flex flex-col justify-center items-between md:flex-row gap-4 w-full">
                <div className="flex flex-col justify-start items-start w-full">
                    ...
                    <input type="text" className="w-full p-2 focus:outline-none border-b-2 focus:border-black " required />
                </div>
                <div className="flex flex-col justify-start items-start w-full">
                    <label className="text-gray-500 font-light w-full text-start">Teléfono</label>
                    <input type="tel" className="w-full p-2 focus:outline-none border-b-2 focus:border-black " pattern="[0-9]{2} [0-9]{4}-[0-9]{4}" required />
                </div>
            </div>
            <div className="flex flex-col justify-start items-start w-full">
                <label className="text-gray-500 font-light w-full text-start">Correo electrónico</label>
                <input type="email" className="w-full p-2 focus:outline-none border-b-2 focus:border-black " required />
            </div>
            <div className="flex flex-col justify-start items-start w-full">
