    ...
    return <section id="Opinions">
        ...
        <div className="flex flex-col justify-center items-start md:flex-row gap-[3rem] md:gap-[1rem] w-[95%] md:w-[70%]">
            <div className="shrink flex flex-col justify-start items-center shrink min-w-[25vw]">
                <Image className="rounded-full aspect-square object-cover" src="/images/Lucia.jpg" alt="Foto de Lucia" width={140} height={140} />
            ...
            <div className="shrink flex flex-col justify-start items-center shrink min-w-[25vw]">
                <Image className="rounded-full aspect-square object-cover" src="/images/Martha.avif" alt="Foto de Martha" width={140} height={140} />
            ...
            <div className="shrink flex flex-col justify-start items-center shrink min-w-[25vw]">
                <Image className="rounded-full aspect-square object-cover" src="/images/JuanF.jpg" alt="Foto de Juan" width={140} height={140} />
